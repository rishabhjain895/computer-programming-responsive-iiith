window.view = {
	...
	validateRectangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a right angled triangle requires the length of the two unique parallel sides of the  right angled triangle. Try again.')
		else if ( b !== 'float' 
			alert('Incorrect datatype of input variables(arguments). The value of the sides of a right angled triangle need not be integers. Try again.')
		else if ( c !== 'float' )
			alert('Incorrect datatype for return type. The value of the area of a right angled triangle need not be an integer. Try again.')
		else if ( d !== '(a*b)*(1/2)' )
	...
	displayFunctionForRectangle: function() {
		document.getElementById('functionRectangle').innerHTML += 'float area_rightangledtriangle (float a,float b)<br>{<br> &emsp; float area = (a*b)/2;<br> &emsp; return area;<br>}'
